        ...
        <div className="team-profile-cards">
          <div class="team">
            <div class="card-info">
              ...
              <div class="card-title">Will Sierra</div>
          ...
          <div class="team">
            <div class="card-info">
              ...
              <div class="card-title">Ramiro Espinosa</div>
              <div class="card-subtitle">Full Stack Developer</div>
            </div>
            <ul class="card-social">
          ...
          <div class="team">
            <div class="card-info">
              ...
              <div class="card-title">Leydi Pretell</div>
              <div class="card-subtitle">Full Stack Developer</div>
            </div>
            <ul class="card-social">
          ...
          <div class="team">
            <div class="card-info">
              ...
              <div class="card-title">Jose Atencia</div>
              <div class="card-subtitle">Full Stack Developer</div>
            </div>
            <ul class="card-social">
          ...
          <div class="team">
            <div class="card-info">
              ...
              <div class="card-title">Isidoro Francisco</div>
              <div class="card-subtitle">Full Stack Developer</div>
            </div>
            <ul class="card-social">
          ...
          <div class="team">
            <div class="card-info">
              ...
              <div class="card-title">Julian Rodriguez</div>
              <div class="card-subtitle">Full Stack Developer</div>
            </div>
            <ul class="card-social">
