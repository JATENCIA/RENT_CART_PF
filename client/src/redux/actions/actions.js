...
export const putCars = (payload) => async () => {
  const billCreated = await axios.put("https://back-pf-production.up.railway.app/cars", payload)
...
export const postAccessories = (payload) => async (dispatch) => {
  try {
    const accessoriesCreated = await axios.post("https://back-pf-production.up.railway.app/accessories", payload)
    return dispatch({
